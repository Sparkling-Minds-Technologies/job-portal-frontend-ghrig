...
const Index = () => {
  return (
    <div className="hidden lg:flex flex-col gap-[51px] w-full">
      ...
      <div className="self-stretch p-10 bg-white rounded-2xl shadow-[6px_6px_54px_0px_rgba(0,0,0,0.05)] outline outline-1 outline-offset-[-1px] outline-neutral-300 flex flex-col justify-start items-start gap-2.5">
      ...
      <div className="self-stretch p-6 bg-white rounded-lg shadow-[0px_1px_2px_0px_rgba(0,0,0,0.03)] outline outline-1 outline-offset-[-1px] outline-zinc-300 flex flex-col justify-start items-start gap-6 overflow-hidden">
        ...
        <div className="self-stretch inline-flex justify-start items-start gap-7">
          <div className="p-6 bg-white rounded-lg shadow-[0px_1px_2px_0px_rgba(0,0,0,0.03)] outline outline-1 outline-offset-[-1px] outline-zinc-300 inline-flex flex-col justify-start items-start gap-4">
        ...
        <div className="inline-flex justify-start items-start gap-6">
          <div className="w-[493px] inline-flex flex-col justify-start items-start gap-7">
            ...
            <div className="w-[493px] rounded-lg outline outline-1 outline-zinc-300 inline-flex justify-start items-start">
